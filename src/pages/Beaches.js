      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="lg:text-4xl text-3xl font-bold text-gray-900">Marine Waters</h1>
              <p className="mt-2 lg:text-lg text-md text-gray-600">Discover our beautiful coastal paradise</p>
            </div>
          </div>
        </div>
      </header>
