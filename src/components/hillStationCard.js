...
export default function HillStationCard({ name, description, address, images, facilities,mapLink }) {
      ...
      <div className="flex flex-col lg:flex-row h-full">
        ...
        <div className="lg:w-3/5 p-8">
          ...
          <div className="flex items-start gap-3 text-gray-600 mb-8 bg-gray-50 p-4 rounded-lg">
            ...
            <span className="text-lg hover:cursor-pointer hover:text-blue-600" onClick={openInMaps}>{address}</span>
          </div>
